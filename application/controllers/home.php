...
class Home extends CI_Controller {
	...
	public function add_to_wishlist($pro_id){
		$product = $this->model_users->add_to_wishlist($pro_id);
		$data['added_to_wishlist']="Added to wish list";
		$data['not_added_to_wishlist']="There was a problem.";
		if($product==TRUE){
			$this->load->view('added_to_wishlist',$data);
		}else{
			$this->load->view('not_added_to_wishlist',$data);
		}
	}
